(function($) {
	...
	$(document).ready(function()
	{
		...
		var dTableDepartment = $('#advanceEntryTable').DataTable({
			...
			ajax: {
				url:'advance/fillgrid',
				type: "get"
			},
			columns: [
			{data:'employeename', name: 'employeename'},
			{data:'posteddate', name: 'posteddate'},
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'advance/delete/'+id;
	});
	...
	$(document).on('click','#editBtn' ,function(){
		...
		console.log('abcd');
		$.ajax({
                url: 'advance/fillform/'+id,
                type: 'get',
                dataType:"JSON",

                success:function(data){
                	$('#employeeid').val(data["employeeid"]).change();
                	$('#vdate').val(data["posteddate"]);
