(function($) {
	...
	$(document).ready(function()
	{
		...
		var datein = document.getElementById('datein').valueAsDate;
		var chequedate = document.getElementById('chequedate').valueAsDate;
		if (datein == null || chequedate == null)
		{
		...
		var dTableDepartment = $('#loanEntryTable').DataTable({
			...
			{data:'allowdedname', name: 'allowdedname'},
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'loan/delete/'+id;
	});
	...
	$(document).on('click','#editBtn' ,function(){
		...
		$.ajax({
                url: 'loan/fillform/'+id,
                type: 'get',
                dataType:"JSON",

                success:function(data){
                	$('#allowdedid').val(data["allowdedid"]).change();
