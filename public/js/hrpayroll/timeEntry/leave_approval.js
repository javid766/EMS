...
$('#dateout').change(function() {
  	var datein = $('#datein').val();
		var dateout = $('#dateout').val();
		showGridDateChange(datein,dateout);
});
...
$(document).ready(function(){
	...
	function showGridDateChange(datein,dateout){
			var searchable = [];
		var selectable = []; 
		var datein = datein;
		var dateout = dateout;
		...
		console.log(dateout);
		var dTableAttcode = $('#leaveEntryTable');
		dTableAttcode.DataTable({
			...
			ajax: {
				url:'leave-approval/fillGridLeaveApproval',
				type: "get",
	...
	$(document).on('click','#approveBtn' ,function(){
		...
		document.getElementById('leaveStatus').value ="approve";
	});
	$(document).on('click','#notApproveBtn' ,function(){
		
		document.getElementById('leaveStatus').value ="notapprove";
	});
