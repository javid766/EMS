(function($) {
	'use strict';
	//Left Status Data Table
	$(document).ready(function()
	{
		var searchable = [];
		var selectable = []; 

		var dTableDepartment = $('#leftStatusTable').DataTable({
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'left-status/delete/'+id;
	});
