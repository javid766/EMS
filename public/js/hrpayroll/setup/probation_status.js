(function($) {
	'use strict';
	//probation Status Data Table
	$(document).ready(function()
	{
		var searchable = [];
		var selectable = []; 

		var dTableDepartment = $('#probationStatusTable').DataTable({
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'probation-status/delete/'+id;
	});
	...
	$(document).on('click','#editBtn' ,function(){
		...
		$('#id').val(id);
		$.ajax({
			url: 'probation-status/fillform/'+id,
			type: 'get',
			dataType:"JSON",
