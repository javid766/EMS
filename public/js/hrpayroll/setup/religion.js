(function($) {
	...
	$(document).ready(function()
	{
		...
		var dTableDepartment = $('#religionTable').DataTable({
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'religion/delete/'+id;
	});
