(function($) {
	'use strict';
	//entitlement Type Data Table
	$(document).ready(function()
	{
		var searchable = [];
		var selectable = []; 

		var dTableDepartment = $('#entitlementTypeTable').DataTable({
		...
		//End entitlement Type Data Table
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'entitlement-type/delete/'+id;
	});
	...
	$(document).on('click','#editBtn' ,function(){
		...
		$.ajax({
                url: 'entitlement-type/fillform/'+id,
                type: 'get',
                dataType:"JSON",
