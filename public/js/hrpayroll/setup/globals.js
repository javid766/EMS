(function($) {
	...
	$(document).ready(function()
	{
		...
		var dTableDepartment = $('#globalsTable').DataTable({
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'configurations/delete/'+id;
	});
	...
	$(document).on('click','#editBtn' ,function(){
		...
		$('#id').val(id);
		$.ajax({
			url: 'configurations/fillform/'+id,
			type: 'get',
			dataType:"JSON",
