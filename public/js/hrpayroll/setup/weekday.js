(function($) {
	...
	$(document).ready(function()
	{
		...
		var dTableDepartment = $('#weekdayTable').DataTable({
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'weekday/delete/'+id;
	});
	...
	$(document).on('click','#editBtn' ,function(){
		...
		$.ajax({
			...
			success:function(data){
				...
				$('#weekday').val(data["weeekday"]).change();
