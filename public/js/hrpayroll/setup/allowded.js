(function($) {
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'allowded/delete/'+id;
	});
	...
	$(document).on('click','#editBtn' ,function(){
		...
		$.ajax({
			...
			success:function(data){
				...
				$('#allowdedGrp').val(data["groupid"]).change();
				$('#allowdedtype').val(data["allowdedtype"]).change();
				$('#amounttype').val(data["amounttype"]).change();
