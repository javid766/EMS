(function($) {
	'use strict';
	//Attendence Code Data Table
	$(document).ready(function()
	{
		var searchable = [];
		var selectable = []; 

		var dTableAttcode = $('#attcodeTable').DataTable({
			...
			{data:'attgroupname', name: 'attgroupname'},
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'attcode/delete/'+id;
	});
