(function($) {
	...
	$(document).ready(function()
	{
		...
		var dTableDepartment = $('#desgTable').DataTable({
			...
			{data:'defaultsalary', name: 'defaultsalary'},
	...
	$(document).on('click','#deleteRecord' ,function(){
		var id = $('#id').val();	
		window.location.href = 'desg/delete/'+id;
	});
	...
	$(document).on('click','#editBtn' ,function(){
		...
		$.ajax({
			...
			success:function(data){
				...
				$('#defaultsalary').val(data["defaultsalary"]);
