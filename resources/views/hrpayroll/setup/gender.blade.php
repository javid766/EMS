	...
	<div class="row">
		<div class="offset-sm-3 col-sm-6">
			<div class="card card-border">
				<form class="forms-sample" method="POST" action="{{url('setup/gender/save')}}" >
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input class="align-checkbox" name="isactive" id="isactive" type="checkbox" width="276" value="1"/>
									</div>
									<div class="help-block with-errors"></div>
									@error('isactive')
									<span class="invalid-feedback" role="alert">
	...
	<div class="row">
		<div class="offset-sm-3 col-sm-6">
			<div class="card p-3 card-border">
				<div class="card-body">
					<table id="genderTable" class="table table-bordered table-striped table-hover">
						<thead>
							<tr>           
								<th>{{ __('Code')}}</th>
								<th>{{ __('Title')}}</th>
...
<!-- push external js -->
@push('script') 
<script src="{{ asset('js/hrpayroll/setup/gender.js') }}"></script> 
@endpush
@endsection
