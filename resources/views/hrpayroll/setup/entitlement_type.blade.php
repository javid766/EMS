...
@section('title', 'Entitlement Type')
@section('content')
    ...
    <div class="row">
        <div class="offset-sm-3 col-sm-6">
            <div class="card card-border">
                <form class="forms-sample" method="POST" action="{{ route('setup-entitlement-type-save') }}" >
                    <div class="card-header">
                        <div class="col-sm-5 header-title">
                            <h3>{{ __('Entitlement Type')}}</h3>
                        </div>
    ...
    <div class="row">
        <div class="offset-sm-3 col-sm-6">
            <div class="card p-3 card-border">
                <div class="card-body">
                    <table id="entitlementTypeTable" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>{{ __('Code')}}</th>
                                <th>{{ __('Title')}}</th>
...
<!-- push external js -->
@push('script') 
<script src="{{ asset('js/hrpayroll/setup/entitlement_type.js') }}"></script> 
@endpush
@endsection
