    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-border">
                <form class="forms-sample" method="POST" action="{{ route('setup-roster-shift-save') }}" >
                    <div class="card-header">
                        <div class="col-sm-5 header-title">
                            <h3>{{ __('Shift Roster')}}</h3>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                        ...
                                        <input name="vcode" id="vcode" type="text" class="form-control input-sm" width="276" value="{{ old('vcode') }}" maxlength="1" placeholder="Code"  required="" />
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input name="workinghrs" id="workinghrs" type="number" step="any"  class="form-control input-sm" width="276" value="{{ old('workinghrs') }}" placeholder="00:00" maxlength="5" required="" onkeypress="return isNumberKey(event)" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2">
        ...
        <div class="col-sm-12">
            <div class="card p-3 card-border">
                <div class="card-body table-responsive-sm">
                    <table id="rosterShiftTable" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>{{ __('Code')}}</th>
                                <th>{{ __('Title')}}</th>
...
<!-- push external js -->
@push('script') 
<script src="{{ asset('js/hrpayroll/setup/roster_shift.js') }}"></script> 
@endpush
@endsection
