...
@section('title', 'Probation Status')
@section('content')
	...
	<div class="row">
		<div class="offset-sm-3 col-sm-6">
			<div class="card card-border">
				<form class="forms-sample" method="POST" action="{{url('setup/probation-status/save')}}" >
					<div class="card-header">
						<div class="col-sm-5 header-title">
							<h3>{{ __('Probation Status')}}</h3>
						</div>
	...
	<div class="row">
		<div class="offset-sm-3 col-sm-6">
			<div class="card p-3 card-border">
				<div class="card-body">
					<table id="probationStatusTable" class="table table-bordered table-striped table-hover">
						<thead>
							<tr>           
								<th>{{ __('Code')}}</th>
								<th>{{ __('Title')}}</th>
...
<!-- push external js -->
@push('script') 
<script src="{{ asset('js/hrpayroll/setup/probation_status.js') }}"></script> 
@endpush
@endsection
