...
<div class="container-fluid">
	...
	<div class="row">
		<div class="offset-sm-3 col-sm-6">
			<div class="card card-border">
				<form class="forms-sample" method="POST" action="{{url('setup/job-status/save')}}" >
	...
	<div class="row">
		<div class="offset-sm-3 col-sm-6">
			<div class="card p-3 card-border">
				<div class="card-body">
					<table id="jobStatusTable" class="table table-bordered table-striped table-hover">
						<thead>
							<tr>           
								<th>{{ __('Code')}}</th>
								<th>{{ __('Title')}}</th>
	...
	<!-- push external js -->
	@push('script') 
	<script src="{{ asset('js/hrpayroll/setup/job_status.js') }}"></script> 
	@endpush
	@endsection
