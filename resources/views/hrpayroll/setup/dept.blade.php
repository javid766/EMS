    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-border">
                <form class="forms-sample" method="POST" action="{{ route('setup-dept-save') }}" >
                    <div class="card-header">
                        <div class="col-sm-5 header-title">
                            <h3>{{ __('Department')}}</h3>
                        </div>
                        <div class="col-7 header-btns">
                            <button  id="save-button" class="btn btn-success  col-md-3" id ="saveBtn">{{ __('Save')}}</button>
                            <a href="#" class="btn btn-warning  col-md-3" id="cancelBtn" >{{ __('Cancel')}}</a> 
                        </div>
                    </div>
                    <div class="card-body">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <label for="strength" class="col-form-label">{{ __('Strength')}}
                                        </label>						
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="deptgroupid" class="col-form-label">{{ __('Department Group')}}</label>
                                        {!! Form::select('deptgroupid',$deptgroups,'required', ['class'=>'form-control select2', 'id'=> 'deptgroupid' , 'placeholder' => '--- Select ---','required'=> 'required']) !!}
                                    </div>
                                    <div class="col-sm-3">
                                        <label for="priority" class="col-form-label">{{ __('Sorting')}}</label>
                                        <input name="priority" id="priority" type="number" class="form-control input-sm" width="276" value="{{ old('priority') }}" placeholder="Sorting" required="" />
                                    </div>
                                    <div class="col-sm-2">
