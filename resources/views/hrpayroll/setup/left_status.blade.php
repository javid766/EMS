	...
	<div class="row">
		<div class="offset-sm-3 col-sm-6">
			<div class="card card-border">
				<form class="forms-sample" method="POST" action="{{url('setup/left-status/save')}}" >
					<div class="card-header">
						<div class="col-sm-5 header-title">
							<h3>{{ __('Left Status')}}</h3>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input id="isactive" type="checkbox" name="isactive" value="1" class="align-checkbox">
									</div>
									<div class="help-block with-errors"></div>
									@error('isactive')
									<span class="invalid-feedback" role="alert">
	...
	<div class="row">
		<div class="offset-sm-3 col-sm-6">
			<div class="card p-3 card-border">
				<div class="card-body">
					<table id="leftStatusTable" class="table table-bordered table-striped table-hover">
						<thead>
							<tr>           
								<th>{{ __('Code')}}</th>
								<th>{{ __('Title')}}</th>
...
<!-- push external js -->
@push('script') 
<script src="{{ asset('js/hrpayroll/setup/left_status.js') }}"></script> 
@endpush
@endsection
