    ...
    <div class="row">
        <div class="offset-lg-3 col-lg-6 col-sm-12">
            <div class="card card-border">
                <form class="forms-sample" method="POST" action="{{ route('setup-country-save') }}" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="vcode" id="vcode" type="text" class="form-control input-sm" width="276" value="{{ old('vcode') }}" placeholder="Country Code" required/>								
                            </div>
...
<!-- push external js -->
@push('script') 
<script src="{{ asset('js/hrpayroll/setup/country.js') }}"></script> 
@endpush
@endsection
