...
class CreateAccfinancialQuarterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('accfinancial_quarter', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('accfinancial_quarter');
    }
}
